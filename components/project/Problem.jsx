                    ...
                    <div>
                        <div className='sm:hidden'>
                            ...
                            <select name="tabs" className="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                <option selected="" value="problem">Problem Statement</option>
                        ...
                        <div className='hidden sm:block'>
                            <div className='border-b border-gray-200'>
                                <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                                    <span className="cursor-pointer border-indigo-500 text-indigo-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm" aria-current="page">Problem Statement</span>
                                    <span className="cursor-pointer border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">Community Solutions</span>
                                </nav>
                            </div>
                        </div>
                    </div>
