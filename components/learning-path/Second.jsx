                    ...
                    <div className='mt-8'>
                        <div className='flex sm:flex-row flex-col select-none border border-gray-300 rounded-md items-stretch divide-y sm:divide-x sm:divide-y-0 divide-gray-300'>
                                ...
                                <div className='divide-y divide-gray-300 w-full'>
                                    <div className='relative px-4 py-3 flex z-10'>
                                        <div className='flex items-center h-5'>
                                            <input type="radio" id="learner-type-option-0" name="learner-type" value="fast" className="h-4 w-4 text-light-blue-600 cursor-pointer" />
                                        </div>
                                        <label htmlFor="learner-type-option-0" className="ml-3 flex flex-col cursor-pointer">
                                            <span className="block text-sm font-medium text-light-blue-900">I&apos;m a fast learner</span>
                                        </label>
                                    </div>
                                    <div className='relative px-4 py-3 flex z-10'>
                                        <div className='flex items-center h-5'>
                                            <input type="radio" id="learner-type-option-1" name="learner-type" checked="" value="ok" className="h-4 w-4 text-light-blue-600 cursor-pointer" />
                                        </div>
                                        <label htmlFor="learner-type-option-1" className="ml-3 flex flex-col cursor-pointer"><span className="block text-sm font-medium text-light-blue-900">I learn at a moderate pace</span></label>
                                    </div>
                                    <div className="relative px-4 py-3 flex z-10">
                                        <div className="flex items-center h-5">
                                            <input type="radio" id="learner-type-option-2" name="learner-type" value="slow" className="h-4 w-4 text-light-blue-600 cursor-pointer" />
                                        </div>
                                        <label htmlFor="learner-type-option-2" className="ml-3 flex flex-col cursor-pointer"><span className="block text-sm font-medium text-light-blue-900">I need long time to understand new things.</span></label>
                                    </div>
                                </div>
                            </div>
                            <div className='flex-shrink-0 py-2 sm:bg-transparent sm:text-inherit bg-black text-white sm:w-36 w-full text-center flex justify-center items-center'>
                                <div>
                                    <h2 className="text-7xl font-extralight">9</h2>
                                    <p>Months</p>
                                </div>
                            </div>
                        </div>
